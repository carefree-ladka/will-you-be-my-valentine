...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Sa,depthTest:!1,depthWrite:!1})}function CT(r,t,n){const a=new Float32Array(Ps),o=new j(0,1,0);return new Yi({name:"SphericalGaussianBlur",defines:{n:Ps,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:a},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:cu(),fragmentShader:`
	...
	`}function DT(r){let t=new WeakMap,n=null;function a(h){if(h&&h.isTexture){const m=h.mapping,p=m===dd||m===pd,v=m===Fs||m===Hr;if(p||v){let g=t.get(h);const x=g!==void 0?g.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==x)return n===null&&(n=new jv(r)),g=p?n.fromEquirectangular(h,g):n.fromCubemap(h,g),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),g.texture;if(g!==void 0)return g.texture;{const S=h.image;return p&&S&&S.height>0||v&&S&&o(S)?(n===null&&(n=new jv(r)),g=p?n.fromEquirectangular(h):n.fromCubemap(h),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),h.addEventListener("dispose",c),g.texture):null}}}return h}function o(h){let m=0;const p=6;for(let v=0;v<p;v++)h[v]!==void 0&&m++;return m===p}function c(h){const m=h.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function f(){t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:a,dispose:f}}function UT(r){const t={};function n(a){if(t[a]!==void 0)return t[a];const o=r.getExtension(a);return t[a]=o,o}return{has:function(a){return n(a)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(a){const o=n(a);return o===null&&ol("WebGLRenderer: "+a+" extension not supported."),o}}}function NT(r,t,n,a){const o={},c=new WeakMap;function f(g){const x=g.target;x.index!==null&&t.remove(x.index);for(const b in x.attributes)t.remove(x.attributes[b]);x.removeEventListener("dispose",f),delete o[x.id];const S=c.get(x);S&&(t.remove(S),c.delete(x)),a.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,n.memory.geometries--}function h(g,x){return o[x.id]===!0||(x.addEventListener("dispose",f),o[x.id]=!0,n.memory.geometries++),x}function m(g){const x=g.attributes;for(const S in x)t.update(x[S],r.ARRAY_BUFFER)}function p(g){const x=[],S=g.index,b=g.attributes.position;let R=0;if(S!==null){const P=S.array;R=S.version;for(let U=0,D=P.length;U<D;U+=3){const F=P[U+0],B=P[U+1],z=P[U+2];x.push(F,B,B,z,z,F)}}else if(b!==void 0){const P=b.array;R=b.version;for(let U=0,D=P.length/3-1;U<D;U+=3){const F=U+0,B=U+1,z=U+2;x.push(F,B,B,z,z,F)}}else return;const M=new(I_(x)?k_:V_)(x,1);M.version=R;const _=c.get(g);_&&t.remove(_),c.set(g,M)}function v(g){const x=c.get(g);if(x){const S=g.index;S!==null&&x.version<S.version&&p(g)}else p(g);return c.get(g)}return{get:h,update:m,getWireframeAttribute:v}}function LT(r,t,n){let a;function o(x){a=x}let c,f;function h(x){c=x.type,f=x.bytesPerElement}function m(x,S){r.drawElements(a,S,c,x*f),n.update(S,a,1)}function p(x,S,b){b!==0&&(r.drawElementsInstanced(a,S,c,x*f,b),n.update(S,a,b))}function v(x,S,b){if(b===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(a,S,0,c,x,0,b);let M=0;for(let _=0;_<b;_++)M+=S[_];n.update(M,a,1)}function g(x,S,b,R){if(b===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let _=0;_<x.length;_++)p(x[_]/f,S[_],R[_]);else{M.multiDrawElementsInstancedWEBGL(a,S,0,c,x,0,R,0,b);let _=0;for(let P=0;P<b;P++)_+=S[P]*R[P];n.update(_,a,1)}}this.setMode=o,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=v,this.renderMultiDrawInstances=g}function OT(r){const t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function a(c,f,h){switch(n.calls++,f){case r.TRIANGLES:n.triangles+=h*(c/3);break;case r.LINES:n.lines+=h*(c/2);break;case r.LINE_STRIP:n.lines+=h*(c-1);break;case r.LINE_LOOP:n.lines+=h*c;break;case r.POINTS:n.points+=h*c;break;default:De("WebGLInfo: Unknown draw mode:",f);break}}function o(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:o,update:a}}function PT(r,t,n){const a=new WeakMap,o=new an;function c(f,h,m){const p=f.morphTargetInfluences,v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,g=v!==void 0?v.length:0;let x=a.get(h);if(x===void 0||x.count!==g){let C=function(){q.dispose(),a.delete(h),h.removeEventListener("dispose",C)};var S=C;x!==void 0&&x.texture.dispose();const b=h.morphAttributes.position!==void 0,R=h.morphAttributes.normal!==void 0,M=h.morphAttributes.color!==void 0,_=h.morphAttributes.position||[],P=h.morphAttributes.normal||[],U=h.morphAttributes.color||[];let D=0;b===!0&&(D=1),R===!0&&(D=2),M===!0&&(D=3);let F=h.attributes.position.count*D,B=1;F>t.maxTextureSize&&(B=Math.ceil(F/t.maxTextureSize),F=t.maxTextureSize);const z=new Float32Array(F*B*4*g),q=new z_(z,F,B,g);q.type=Gi,q.needsUpdate=!0;const T=D*4;for(let H=0;H<g;H++){const Q=_[H],J=P[H],ct=U[H],rt=F*B*4*H;for(let I=0;I<Q.count;I++){const V=I*T;b===!0&&(o.fromBufferAttribute(Q,I),z[rt+V+0]=o.x,z[rt+V+1]=o.y,z[rt+V+2]=o.z,z[rt+V+3]=0),R===!0&&(o.fromBufferAttribute(J,I),z[rt+V+4]=o.x,z[rt+V+5]=o.y,z[rt+V+6]=o.z,z[rt+V+7]=0),M===!0&&(o.fromBufferAttribute(ct,I),z[rt+V+8]=o.x,z[rt+V+9]=o.y,z[rt+V+10]=o.z,z[rt+V+11]=ct.itemSize===4?o.w:1)}}x={count:g,texture:q,size:new qt(F,B)},a.set(h,x),h.addEventListener("dispose",C)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,n);else{let b=0;for(let M=0;M<p.length;M++)b+=p[M];const R=h.morphTargetsRelative?1:1-b;m.getUniforms().setValue(r,"morphTargetBaseInfluence",R),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",x.texture,n),m.getUniforms().setValue(r,"morphTargetsTextureSize",x.size)}return{update:c}}function IT(r,t,n,a){let o=new WeakMap;function c(m){const p=a.render.frame,v=m.geometry,g=t.get(m,v);if(o.get(g)!==p&&(t.update(g),o.set(g,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",h)===!1&&m.addEventListener("dispose",h),o.get(m)!==p&&(n.update(m.instanceMatrix,r.ARRAY_BUFFER),m.instanceColor!==null&&n.update(m.instanceColor,r.ARRAY_BUFFER),o.set(m,p))),m.isSkinnedMesh){const x=m.skeleton;o.get(x)!==p&&(x.update(),o.set(x,p))}return g}function f(){o=new WeakMap}function h(m){const p=m.target;p.removeEventListener("dispose",h),n.remove(p.instanceMatrix),p.instanceColor!==null&&n.remove(p.instanceColor)}return{update:c,dispose:f}}const zT={[y_]:"LINEAR_TONE_MAPPING",[S_]:"REINHARD_TONE_MAPPING",[M_]:"CINEON_TONE_MAPPING",[E_]:"ACES_FILMIC_TONE_MAPPING",[T_]:"AGX_TONE_MAPPING",[A_]:"NEUTRAL_TONE_MAPPING",[b_]:"CUSTOM_TONE_MAPPING"};function FT(r,t,n,a,o){const c=new Xi(t,n,{type:r,depthBuffer:a,stencilBuffer:o}),f=new Xi(t,n,{type:Ea,depthBuffer:!1,stencilBuffer:!1}),h=new Qn;h.setAttribute("position",new Ln([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Ln([0,2,0,0,2,0],2));const m=new RE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),p=new on(h,m),v=new Sp(-1,1,1,-1,0,1);let g=null,x=null,S=!1,b,R=null,M=[],_=!1;this.setSize=function(P,U){c.setSize(P,U),f.setSize(P,U);for(let D=0;D<M.length;D++){const F=M[D];F.setSize&&F.setSize(P,U)}},this.setEffects=function(P){M=P,_=M.length>0&&M[0].isRenderPass===!0;const U=c.width,D=c.height;for(let F=0;F<M.length;F++){const B=M[F];B.setSize&&B.setSize(U,D)}},this.begin=function(P,U){if(S||P.toneMapping===ki&&M.length===0)return!1;if(R=U,U!==null){const D=U.width,F=U.height;(c.width!==D||c.height!==F)&&this.setSize(D,F)}return _===!1&&P.setRenderTarget(c),b=P.toneMapping,P.toneMapping=ki,!0},this.hasRenderPass=function(){return _},this.end=function(P,U){P.toneMapping=b,S=!0;let D=c,F=f;for(let B=0;B<M.length;B++){const z=M[B];if(z.enabled!==!1&&(z.render(P,F,D,U),z.needsSwap!==!1)){const q=D;D=F,F=q}}if(g!==P.outputColorSpace||x!==P.toneMapping){g=P.outputColorSpace,x=P.toneMapping,m.defines={},Ue.getTransfer(g)===Ve&&(m.defines.SRGB_TRANSFER="");const B=zT[x];B&&(m.defines[B]=""),m.needsUpdate=!0}m.uniforms.tDiffuse.value=D.texture,P.setRenderTarget(R),P.render(p,v),R=null,S=!1},this.isCompositing=function(){return S},this.dispose=function(){c.dispose(),f.dispose(),h.dispose(),m.dispose()}}const ox=new Gn,tp=new ll(1,1),lx=new z_,cx=new bM,ux=new q_,Jv=[],$v=[],t_=new Float32Array(16),e_=new Float32Array(9),n_=new Float32Array(4);function jr(r,t,n){const a=r[0];if(a<=0||a>0)return r;const o=t*n;let c=Jv[o];if(c===void 0&&(c=new Float32Array(o),Jv[o]=c),t!==0){a.toArray(c,0);for(let f=1,h=0;f!==t;++f)h+=n,r[f].toArray(c,h)}return c}function gn(r,t){if(r.length!==t.length)return!1;for(let n=0,a=r.length;n<a;n++)if(r[n]!==t[n])return!1;return!0}function vn(r,t){for(let n=0,a=t.length;n<a;n++)r[n]=t[n]}function uu(r,t){let n=$v[t];n===void 0&&(n=new Int32Array(t),$v[t]=n);for(let a=0;a!==t;++a)n[a]=r.allocateTextureUnit();return n}function BT(r,t){const n=this.cache;n[0]!==t&&(r.uniform1f(this.addr,t),n[0]=t)}function HT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(gn(n,t))return;r.uniform2fv(this.addr,t),vn(n,t)}}function GT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(gn(n,t))return;r.uniform3fv(this.addr,t),vn(n,t)}}function VT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(gn(n,t))return;r.uniform4fv(this.addr,t),vn(n,t)}}function kT(r,t){const n=this.cache,a=t.elements;if(a===void 0){if(gn(n,t))return;r.uniformMatrix2fv(this.addr,!1,t),vn(n,t)}else{if(gn(n,a))return;n_.set(a),r.uniformMatrix2fv(this.addr,!1,n_),vn(n,a)}}function XT(r,t){const n=this.cache,a=t.elements;if(a===void 0){if(gn(n,t))return;r.uniformMatrix3fv(this.addr,!1,t),vn(n,t)}else{if(gn(n,a))return;e_.set(a),r.uniformMatrix3fv(this.addr,!1,e_),vn(n,a)}}function WT(r,t){const n=this.cache,a=t.elements;if(a===void 0){if(gn(n,t))return;r.uniformMatrix4fv(this.addr,!1,t),vn(n,t)}else{if(gn(n,a))return;t_.set(a),r.uniformMatrix4fv(this.addr,!1,t_),vn(n,a)}}function qT(r,t){const n=this.cache;n[0]!==t&&(r.uniform1i(this.addr,t),n[0]=t)}function YT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(gn(n,t))return;r.uniform2iv(this.addr,t),vn(n,t)}}function jT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(gn(n,t))return;r.uniform3iv(this.addr,t),vn(n,t)}}function ZT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(gn(n,t))return;r.uniform4iv(this.addr,t),vn(n,t)}}function QT(r,t){const n=this.cache;n[0]!==t&&(r.uniform1ui(this.addr,t),n[0]=t)}function KT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(gn(n,t))return;r.uniform2uiv(this.addr,t),vn(n,t)}}function JT(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(gn(n,t))return;r.uniform3uiv(this.addr,t),vn(n,t)}}function $T(r,t){const n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(gn(n,t))return;r.uniform4uiv(this.addr,t),vn(n,t)}}function tA(r,t,n){const a=this.cache,o=n.allocateTextureUnit();a[0]!==o&&(r.uniform1i(this.addr,o),a[0]=o);let c;this.type===r.SAMPLER_2D_SHADOW?(tp.compareFunction=n.isReversedDepthBuffer()?pp:dp,c=tp):c=ox,n.setTexture2D(t||c,o)}function eA(r,t,n){const a=this.cache,o=n.allocateTextureUnit();a[0]!==o&&(r.uniform1i(this.addr,o),a[0]=o),n.setTexture3D(t||cx,o)}function nA(r,t,n){const a=this.cache,o=n.allocateTextureUnit();a[0]!==o&&(r.uniform1i(this.addr,o),a[0]=o),n.setTextureCube(t||ux,o)}function iA(r,t,n){const a=this.cache,o=n.allocateTextureUnit();a[0]!==o&&(r.uniform1i(this.addr,o),a[0]=o),n.setTexture2DArray(t||lx,o)}function aA(r){switch(r){case 5126:return BT;case 35664:return HT;case 35665:return GT;case 35666:return VT;case 35674:return kT;case 35675:return XT;case 35676:return WT;case 5124:case 35670:return qT;case 35667:case 35671:return YT;case 35668:case 35672:return jT;case 35669:case 35673:return ZT;case 5125:return QT;case 36294:return KT;case 36295:return JT;case 36296:return $T;case 35678:case 36198:case 36298:case 36306:case 35682:return tA;case 35679:case 36299:case 36307:return eA;case 35680:case 36300:case 36308:case 36293:return nA;case 36289:case 36303:case 36311:case 36292:return iA}}function sA(r,t){r.uniform1fv(this.addr,t)}function rA(r,t){const n=jr(t,this.size,2);r.uniform2fv(this.addr,n)}function oA(r,t){const n=jr(t,this.size,3);r.uniform3fv(this.addr,n)}function lA(r,t){const n=jr(t,this.size,4);r.uniform4fv(this.addr,n)}function cA(r,t){const n=jr(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,n)}function uA(r,t){const n=jr(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,n)}function fA(r,t){const n=jr(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,n)}function hA(r,t){r.uniform1iv(this.addr,t)}function dA(r,t){r.uniform2iv(this.addr,t)}function pA(r,t){r.uniform3iv(this.addr,t)}function mA(r,t){r.uniform4iv(this.addr,t)}function gA(r,t){r.uniform1uiv(this.addr,t)}function vA(r,t){r.uniform2uiv(this.addr,t)}function _A(r,t){r.uniform3uiv(this.addr,t)}function xA(r,t){r.uniform4uiv(this.addr,t)}function yA(r,t,n){const a=this.cache,o=t.length,c=uu(n,o);gn(a,c)||(r.uniform1iv(this.addr,c),vn(a,c));let f;this.type===r.SAMPLER_2D_SHADOW?f=tp:f=ox;for(let h=0;h!==o;++h)n.setTexture2D(t[h]||f,c[h])}function SA(r,t,n){const a=this.cache,o=t.length,c=uu(n,o);gn(a,c)||(r.uniform1iv(this.addr,c),vn(a,c));for(let f=0;f!==o;++f)n.setTexture3D(t[f]||cx,c[f])}function MA(r,t,n){const a=this.cache,o=t.length,c=uu(n,o);gn(a,c)||(r.uniform1iv(this.addr,c),vn(a,c));for(let f=0;f!==o;++f)n.setTextureCube(t[f]||ux,c[f])}function EA(r,t,n){const a=this.cache,o=t.length,c=uu(n,o);gn(a,c)||(r.uniform1iv(this.addr,c),vn(a,c));for(let f=0;f!==o;++f)n.setTexture2DArray(t[f]||lx,c[f])}function bA(r){switch(r){case 5126:return sA;case 35664:return rA;case 35665:return oA;case 35666:return lA;case 35674:return cA;case 35675:return uA;case 35676:return fA;case 5124:case 35670:return hA;case 35667:case 35671:return dA;case 35668:case 35672:return pA;case 35669:case 35673:return mA;case 5125:return gA;case 36294:return vA;case 36295:return _A;case 36296:return xA;case 35678:case 36198:case 36298:case 36306:case 35682:return yA;case 35679:case 36299:case 36307:return SA;case 35680:case 36300:case 36308:case 36293:return MA;case 36289:case 36303:case 36311:case 36292:return EA}}class TA{constructor(t,n,a){this.id=t,this.addr=a,this.cache=[],this.type=n.type,this.setValue=aA(n.type)}}class AA{constructor(t,n,a){this.id=t,this.addr=a,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=bA(n.type)}}class wA{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,n,a){const o=this.seq;for(let c=0,f=o.length;c!==f;++c){const h=o[c];h.setValue(t,n[h.id],a)}}}const nd=/(\w+)(\])?(\[|\.)?/g;function i_(r,t){r.seq.push(t),r.map[t.id]=t}function RA(r,t,n){const a=r.name,o=a.length;for(nd.lastIndex=0;;){const c=nd.exec(a),f=nd.lastIndex;let h=c[1];const m=c[2]==="]",p=c[3];if(m&&(h=h|0),p===void 0||p==="["&&f+2===o){i_(n,p===void 0?new TA(h,r,t):new AA(h,r,t));break}else{let g=n.map[h];g===void 0&&(g=new wA(h),i_(n,g)),n=g}}}class nu{constructor(t,n){this.seq=[],this.map={};const a=t.getProgramParameter(n,t.ACTIVE_UNIFORMS);for(let f=0;f<a;++f){const h=t.getActiveUniform(n,f),m=t.getUniformLocation(n,h.name);RA(h,m,this)}const o=[],c=[];for(const f of this.seq)f.type===t.SAMPLER_2D_SHADOW||f.type===t.SAMPLER_CUBE_SHADOW||f.type===t.SAMPLER_2D_ARRAY_SHADOW?o.push(f):c.push(f);o.length>0&&(this.seq=o.concat(c))}setValue(t,n,a,o){const c=this.map[n];c!==void 0&&c.setValue(t,a,o)}setOptional(t,n,a){const o=n[a];o!==void 0&&this.setValue(t,a,o)}static upload(t,n,a,o){for(let c=0,f=n.length;c!==f;++c){const h=n[c],m=a[h.id];m.needsUpdate!==!1&&h.setValue(t,m.value,o)}}static seqWithValue(t,n){const a=[];for(let o=0,c=t.length;o!==c;++o){const f=t[o];f.id in n&&a.push(f)}return a}}function a_(r,t,n){const a=r.createShader(t);return r.shaderSource(a,n),r.compileShader(a),a}const CA=37297;let DA=0;function UA(r,t){const n=r.split(`
`),a=[],o=Math.max(t-6,0),c=Math.min(t+6,n.length);for(let f=o;f<c;f++){const h=f+1;a.push(`${h===t?">":" "} ${h}: ${n[f]}`)}return a.join(`
`)}const s_=new xe;function NA(r){Ue._getMatrix(s_,Ue.workingColorSpace,r);const t=`mat3( ${s_.elements.map(n=>n.toFixed(4))} )`;switch(Ue.getTransfer(r)){case iu:return[t,"LinearTransferOETF"];case Ve:return[t,"sRGBTransferOETF"];default:return de("WebGLProgram: Unsupported color space: ",r),[t,"LinearTransferOETF"]}}function r_(r,t,n){const a=r.getShaderParameter(t,r.COMPILE_STATUS),c=(r.getShaderInfoLog(t)||"").trim();if(a&&c==="")return"";const f=/ERROR: 0:(\d+)/.exec(c);if(f){const h=parseInt(f[1]);return n.toUpperCase()+`

`+c+`

`+UA(r.getShaderSource(t),h)}else return c}function LA(r,t){const n=NA(t);return[`vec4 ${r}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}const OA={[y_]:"Linear",[S_]:"Reinhard",[M_]:"Cineon",[E_]:"ACESFilmic",[T_]:"AgX",[A_]:"Neutral",[b_]:"Custom"};function PA(r,t){const n=OA[t];return n===void 0?(de("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Qc=new j;function IA(){Ue.getLuminanceCoefficients(Qc);const r=Qc.x.toFixed(4),t=Qc.y.toFixed(4),n=Qc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function zA(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(tl).join(`
`)}function FA(r){const t=[];for(const n in r){const a=r[n];a!==!1&&t.push("#define "+n+" "+a)}return t.join(`
`)}function BA(r,t){const n={},a=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let o=0;o<a;o++){const c=r.getActiveAttrib(t,o),f=c.name;let h=1;c.type===r.FLOAT_MAT2&&(h=2),c.type===r.FLOAT_MAT3&&(h=3),c.type===r.FLOAT_MAT4&&(h=4),n[f]={type:c.type,location:r.getAttribLocation(t,f),locationSize:h}}return n}function tl(r){return r!==""}function o_(r,t){const n=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function l_(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const HA=/^[ \t]*#include +<([\w\d./]+)>/gm;function ep(r){return r.replace(HA,VA)}const GA=new Map;function VA(r,t){let n=ye[t];if(n===void 0){const a=GA.get(t);if(a!==void 0)n=ye[a],de('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,a);else throw new Error("Can not resolve #include <"+t+">")}return ep(n)}const kA=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function c_(r){return r.replace(kA,XA)}function XA(r,t,n,a){let o="";for(let c=parseInt(t);c<parseInt(n);c++)o+=a.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return o}function u_(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}const WA={[Kc]:"SHADOWMAP_TYPE_PCF",[Ko]:"SHADOWMAP_TYPE_VSM"};function qA(r){return WA[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const YA={[Fs]:"ENVMAP_TYPE_CUBE",[Hr]:"ENVMAP_TYPE_CUBE",[ru]:"ENVMAP_TYPE_CUBE_UV"};function jA(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":YA[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const ZA={[Hr]:"ENVMAP_MODE_REFRACTION"};function QA(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":ZA[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const KA={[rp]:"ENVMAP_BLENDING_MULTIPLY",[sM]:"ENVMAP_BLENDING_MIX",[rM]:"ENVMAP_BLENDING_ADD"};function JA(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":KA[r.combine]||"ENVMAP_BLENDING_NONE"}function $A(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const n=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:a,maxMip:n}}function t2(r,t,n,a){const o=r.getContext(),c=n.defines;let f=n.vertexShader,h=n.fragmentShader;const m=qA(n),p=jA(n),v=QA(n),g=JA(n),x=$A(n),S=zA(n),b=FA(c),R=o.createProgram();let M,_,P=n.glslVersion?"#version "+n.glslVersion+`
